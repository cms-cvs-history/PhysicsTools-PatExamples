#ifndef PhysicsTools_PatExamples_interface_WPlusJetsTopAnaXMuonEventSelector_h
#define PhysicsTools_PatExamples_interface_WPlusJetsTopAnaXMuonEventSelector_h
...
class WPlusJetsTopAnaXMuonEventSelector : public pat::PatEventSelector {
 public:
  WPlusJetsTopAnaXMuonEventSelector( 
