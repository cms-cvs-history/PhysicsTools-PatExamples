...
int main ( int argc, char ** argv )
{
  ...
  muonId->set( "D0", 0.02 );
  muonId->set( "NHits", false );
  muonId->set( "ECalVeto", false );
  muonId->set( "HCalVeto", false );
  // Tight electron id
  ...
  boost::shared_ptr<WPlusJetsTopAnaXElectronEventSelector> 
    wPlusJets( new WPlusJetsTopAnaXElectronEventSelector( 
     muonId,
     electronIdTight,
     jetIdTight,
     electronIdLoose,
